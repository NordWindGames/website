 ...
 *
 * Declared above SOCIAL_CHANNELS because the Discord entry in that list is this
 * same invite wearing an icon - one URL, two presentations. Kept as named
 * constants because posts link to both in prose, not just as icons in a row.
 *
 * PLAYTEST_SIGNUP is an internal path: the signup form lives on the HoldStrong
